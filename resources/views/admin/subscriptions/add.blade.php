...
@section('content')
    <div class="card mb-3">
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor">Subscriptions :: Subscription Add </h5>
                </div>
        ...
        <div class="card-body">
            <form class="row" id="add" method="POST" action="{{ route('admin.subscriptions.add') }}"
                ...
                <div class="col-lg-6 mt-2">
                    ...
                    <select name="status" class="form-select" id="status">
                        <option value="1" @selected(old('status', 1) == 1)> Approved </option>
                        <option value="2" @selected(old('status', 1) == 2)> Rejected </option>
