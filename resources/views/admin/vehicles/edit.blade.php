...
@section('content')
    <div class="card mb-3">
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor">Vehicles :: Vehicle Edit </h5>
                </div>
        ...
        <div class="card-body">
            <form class="row" id="editVehicle" method="POST" action="{{ route('admin.vehicles.edit', $vehicle['id']) }}"
                enctype='multipart/form-data'>
                @csrf
                <div class="col-lg-6 mt-2">
                    <label class="form-label" for="brand_id">Brand <span class="required">*</span></label>
                ...
                <div class="col-lg-6 mt-2">
                    ...
                    <select name="status" class="form-select" id="status">
                        <option value="1" @selected(old('status', $vehicle['status']) == 1)> Active </option>
                ...
                <div class="col-lg-6 mt-2">
                    ...
                    <div class="img-group mb-2">
                        <img class="" src="{{ asset('storage/' . $vehicle['image']) }}" alt="">
                    </div>
                    @error('image')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
