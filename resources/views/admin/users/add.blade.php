...
<div class="card mb-3">
        ...
        <div class="row flex-between-end">
            ...
            <div class="col-auto ms-auto">
                <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <a href="{{ route('admin.users')  }}" class="btn btn-outline-secondary"> <i
    ...
    <div class="card-body">
        <form class="row" id="addUser" method="POST" action="{{ route('admin.users.add') }}" enctype='multipart/form-data'>
            @csrf
