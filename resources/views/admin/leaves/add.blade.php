...
@section('content')
    <div class="card mb-3">
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor">Leaves :: Leave Add </h5>
                </div>
        ...
        <div class="card-body">
            <form class="row" id="add" method="POST" action="{{ route('admin.leaves.add') }}"
                ...
                <div class="col-lg-6 mt-2">
                    ...
                    <textarea class="form-control" id="reason" placeholder="Enter Reason" name="reason" type="text">{{ old('reason') }}</textarea>
                    @error('reason')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
