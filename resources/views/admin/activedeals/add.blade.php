...
<div class="card mb-3">
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0" data-anchor="data-anchor">Active Deals :: Active Deals Add </h5>
            </div>
            <div class="col-auto ms-auto">
                <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <a href="{{ route('admin.active-deals')  }}" class="btn btn-outline-secondary">
    ...
    <div class="card-body">
        <form class="row" id="add" method="POST" action="{{ route('admin.active-deals.add') }}" enctype='multipart/form-data'>
            @csrf
            <div class="col-lg-6 mt-2">
                <label class="form-label" for="offer_type">Offer Type <span class="required">*</span></label>
             ...
             <div class="col-lg-6 mt-2">
                <label class="form-label" for="valid_date">Valid Date<span class="required">*</span></label>
                <input class="form-control" id="valid_date" placeholder="Valid Date" name="valid_date" type="date"
            ...
            <div class="col-lg-6 mt-2">
                ...
                <input class="form-control" id="discount" placeholder="Discount" name="discount" type="text"
                    value="{{ old('discount') }}" />
                @error('discount')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
