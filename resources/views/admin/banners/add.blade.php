...
@section('content')
    <div class="card mb-3">
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor">Banners :: Banner Add </h5>
                </div>
        ...
        <div class="card-body">
            <form class="row" id="add" method="POST" action="{{ route('admin.banners.add') }}"
                ...
                <div class="col-lg-6 mt-2">
                    ...
                    <select name="banner_type" class="form-select" id="status">
                        <option value="up" @selected(old('status', 1) == 1)> UP </option>
                        <option value="down" @selected(old('status', 1) == 0)> Down </option>
                    </select>
                    @error('status')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
