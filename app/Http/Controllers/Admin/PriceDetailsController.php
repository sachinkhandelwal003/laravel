...
class PriceDetailsController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = PriceDetail::select('id', 'magicwash_discount', 'plateform_fee', 'tax', 'status', 'created_at');
    ...
    {
        return view('admin.pricedetails.add');
    }

    public function save(Request $request): RedirectResponse
    {
        $validated = $request->validate([
            'magicwash_discount'         => ['required'],
        ...
        PriceDetail::create($validated);
        return to_route('admin.price-details')->withSuccess('Price Details Added Successfully..!!');
    }
