...
class CleanerEarningController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = CleanerEarning::select('id', 'price', 'unit', 'status','car_type', 'created_at');
        ...
        return view('admin.cleanerearning.index');
    }

    public function add(): View
    {
        return view('admin.cleanerearning.add');
    }
    ...
    public function save(Request $request): RedirectResponse
    {
        ...
        CleanerEarning::create($validated);
        return to_route('admin.cleaner-earning')->withSuccess('Cleaner Earning Added Successfully..!!');
    }
