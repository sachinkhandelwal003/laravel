...
class RewardController extends Controller
{
    ...
    {
        try {
            \Log::info('ToggleStatus request received: ', $request->all());
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->editColumn('status', function ($row) {
                    ...
                    return '<small class="badge fw-semi-bold rounded-pill status ' . $statusClass . ' toggle-status" style="cursor:pointer;" data-id="' . $row['id'] . '" data-status="' . $row['status'] . '">' . $statusText . '</small>';
                })
    ...
    public function save(Request $request): RedirectResponse
    {
        ...
        // Create reward with generated code
