...
class Helper
{
    ...
    public static function getVehicleImage(string|null $type): string|null
    {
        $vehicleImages = [
            1 => 'assets/img/hacback.png',
            2 => 'assets/img/saden.png',
            3 => 'assets/img/suv.png',
            4 => 'assets/img/bike.png',
            5 => 'assets/img/scooty.png',
        ];

        // Return the corresponding image or default if not found
        return asset($vehicleImages[$type] ?? 'assets/img/img-not-found.png');
    }
    public static function showImage(string|null $filename, bool $showDefault = false): string|null
    {
        if ($filename) {
            ...
            // Also check if the file exists with direct path (fallback)
